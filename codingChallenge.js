...
display the next random question, so that  the game
never ends.
HINT:write a function for this and call it right after displaying the result

9.Be careful: after Task 8, the game literally never ends. So include the option to quit the game if the user writes 'exit' insteand of the answer.
In this case, Don't call the function from tasks 8.

10. track the user's score to make the game more fun!
So each time an answer is correct, add 1 point to the score.
Hint: I'm going to use the power of closures for this, but you don't have to, just to this with the tools you feel more comfortable at this point.
